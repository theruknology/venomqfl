"""
data/mnist.py: DataLoader for MNIST dataset for QFLBackdoorAttacks
"""
import torch
...
def get_dataloaders(config):
    ...
    if data_distribution == 'iid':
        # Evenly split train_subset among clients
        ...
        # Non-IID: sort by label, assign consecutive chunks
